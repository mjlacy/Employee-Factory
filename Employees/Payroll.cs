...
namespace Employees
{
    class Payroll
    {
        ...
        void PopulateEmployee()
        {
            ...
            if (index != -99)
            {
                ...
                if (type.Equals("h", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    decimal hoursWorked = System.Convert.ToDecimal(Console.ReadLine());

                    Console.WriteLine("\nPlease Enter rate, (ex for $20 an hour enter 20):");
                    decimal hourlyWage = System.Convert.ToDecimal(Console.ReadLine());
                ...
                else if (type.Equals("s", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    decimal grossPay = 0m;
                    do {
                        Console.WriteLine("\nIs this employee Staff(s) or Executive(e)? Please answer h/s/c");
                ...
                else if (type.Equals("c", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    decimal grossSales = System.Convert.ToDecimal(Console.ReadLine());

                    Console.WriteLine("\nPlease enter the price per Unit:");
                    decimal commissonRate = System.Convert.ToDecimal(Console.ReadLine());
        ...
        void ChooseEmployee()
        {
            ...
            {
                //We Dont really need this code, I just found it was useful to test
                //myEmployees[choice - 1].CalcGrossPay();
                //myEmployees[choice - 1].CalcTax();
                //myEmployees[choice - 1].CalcNetPay();
                //myEmployees[choice - 1].CalcNetperc();
                //myEmployees[choice - 1].displayEmployee();
